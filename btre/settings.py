...
ALLOWED_HOSTS = ['*','https://web-production-4904.up.railway.app/]
CSRF_TRUSTED_ORIGINS = ['*', 'localhost', '127.0.0.1','web-production-4904.up.railway.app','https://web-production-4904.up.railway.app/]
